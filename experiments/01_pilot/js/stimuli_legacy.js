...
var all_contexts =
  [{
    ...
    "property": "speed", // depends on adjectivePair
    "target": "Uber driver", // depends on adjectivePair, targetType

    "context1": "Jane is taking an Uber to the airport. She wants the driver to drive ...fast because she is late for a flight.", // depends on adjectivePair, targetType, value, name
    "context1": "Jane is taking an Uber to the airport. She wants the driver to drive ...slowly because she gets carsick.",
    "context2": "Once she's made it to the gate, she calls her colleague, who she was texting about her issue during the Uber ride. Jane says:", // depends on adjectivePair, targetType, name

    "questionState": "What was the SPEED of the UBER DRIVER?", // depends on adjectivePair, targetType (directly uses property, target)
    "questionValue": "What SPEED did JANE want the UBER DRIVER to have?" // depends on adjectivePair, name, targetType (directly uses property, name, target)
  }]

var all_sentences =
  [{"adjectivePair": "fast-slow",
    "adjective": "fast", // redundant?
    "targetType": "human",
    "polarity": "pos",
    "negation": "1",

    "subject": "His driving", // depends on adjectivePair, targetType

    "sentence": "His driving wasn't fast.", // directly uses subject, adjective, negation

    "intention": "Think about JANE's intetion in saying 'SENTENCE.'", // directly uses name, sentence
    "questionHonest": "How important was it to JANE to be honest?", // directly uses name
    "questionPositive": "How important was it to JANE to be positive?" // directly uses name
  }]
